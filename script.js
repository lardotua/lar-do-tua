...
function navigate(page, roomId) {
  // Se pedir detalhe de quarto, abre o modal em vez de mudar de página
      ...
      <div class="detail-grid">
        ...
        <div class="detail-info-col">
          ...
          <div class="desc-block" id="descBlock">
            <p class="desc-text" id="descText">${room.desc || ''}</p>
...
document.addEventListener('keydown', e => {
  if (e.key === 'Escape') {
    if (_lbOpen) { closeLightbox(); } else { closeRoomModal(); }
  }
