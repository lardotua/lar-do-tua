...
function renderRoomDetail(id) {
    ...
    <div class="detail-grid">
      ...
      <div class="detail-info-col">
        ...
        <div class="desc-block" id="descBlock">
          <p class="desc-text" id="descText" style="white-space:pre-line;line-height:1.8;color:rgba(30,42,58,0.85)">${room.desc || ''}</p>
  ...
  setTimeout(() => {
    ...
    if (el && btn) {
      // Remove colapso temporariamente para medir altura real
